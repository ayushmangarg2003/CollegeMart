...
const AddProductPage = () => {
  ...
  <div className="w-full max-w-7xl mx-auto">
    ...
    <div className="mb-8">
      <nav className="mb-4">
        <ol className="flex items-center space-x-2 text-sm text-neutral-600">
          ...
          <li>/</li>
          <li>
            <a href="/marketplace" className="hover:text-[#cc0000] transition">
              Marketplace
            </a>
          </li>
          <li>/</li>
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      {/* Two-Column Layout for Name and Image */}
      ...
      <div className="space-y-2">
        <label className="block text-lg font-medium text-gray-700">
          Description <span className="text-sm text-gray-400">({description.length}/500 characters)</span>
        </label>
        <textarea
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label className="block text-lg font-medium text-gray-700">
            Original Price ($) <span className="text-sm text-gray-400">(Optional)</span>
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <span className="text-gray-500">$</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label className="block text-lg font-medium text-gray-700">Condition</label>
          <select
      ...
      <div className="space-y-3">
        <label className="block text-lg font-medium text-gray-700">Product Tags</label>
